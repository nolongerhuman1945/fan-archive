    ...
    <div>
      ...
      <div className="bg-white dark:bg-warm-800 rounded-md border border-warm-200 dark:border-warm-700 p-6 md:p-8 mb-8">
        ...
        <div className="pt-6 border-t border-warm-200 dark:border-warm-700">
          <h2 className="text-xl font-medium mb-4 text-warm-900 dark:text-warm-50 tracking-tight">Chapters</h2>
              ...
              {metadata.chapters.map((chapter, index) => {
                ...
                return (
                  <Link
                    ...
                    className="block p-4 bg-warm-50 dark:bg-warm-700 rounded-md border border-warm-200 dark:border-warm-600 hover:border-warm-400 dark:hover:border-warm-500 hover:bg-warm-100 dark:hover:bg-warm-600 transition-all group"
                  >
                    <div className="font-medium text-warm-900 dark:text-warm-50 mb-1 group-hover:opacity-80 transition-opacity text-sm">
                      Chapter {chapterNum}
                    </div>
                    {chapter.title && (
